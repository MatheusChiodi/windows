          ...
          <div className="overflow-y-auto">
            ...
            <div className="flex bg-[#3c3c3c] hover:bg-[#4d4d4d] mx-2 rounded-md pb-2 pt-1 items-center cursor-pointer">
              <img
                src="logo.png"
                alt="logo"
                className="w-[50px] h-[50px] rounded-full mt-1"
              />
              <div className="ps-2">
                <p className="text-gray-100 font-medium">Matheus Chiodi</p>
                <div className="flex items-center">
                  <CheckCheck size={20} className="text-[#3471c3] mr-1" />
                  <p className="text-gray-100 text-xs">Olá, pessoal! 👋🏼</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-[80%] mx-[1px]">
                ...
                <div className="bg-[#025c4c] rounded-md px-2 py-1 m-1 mt-2">
                  <div className="text-gray-100">
                    <p className="text-sm mr-[50px] m-0 p-0 w-[500px] text-justify">
                      Olá, pessoal! 👋🏼 <br />
                      Eu sou um programador com mais de 2 anos de experiência e
                      gostaria de compartilhar com vocês um pouco sobre minha
                      jornada e habilidades técnicas. 💻 <br />
                      Durante esse tempo, trabalhei com diversas tecnologias,
                      aprimorando minhas habilidades e buscando soluções
                      inovadoras. Algumas das tecnologias com as quais tenho
                      experiência incluem: JavaScript, CodeIgniter, PHP, SQL e
                      ReactJS <br />
                      <br />
                    </p>
                    <p className="text-sm mr-[50px] m-0 p-0 w-[500px]">
                      ...
                      <a
                        ...
                        className="hover:text-gray-300 transition-all duration-500"
                      >
                        https://www.linkedin.com/in/matheus-chiodi-b484581aa/
                      </a>
                      <br />
                    </p>
                    <div className="w-full flex justify-end items-center m-0 p-0">
                      <p className="text-gray-100 text-[9px] m-0 p-0">10:00</p>
          ...
          <div className="bg-[#272727] w-full h-[45px] flex items-center justify-between px-1">
            <div className="flex items-center gap-2 w-full">
              ...
              <input
                type="text"
                className="bg-[#272727] hover:bg-[#3c3c3c] text-gray-100 outline-none text-xs h-[38px] px-2 w-[100%]"
